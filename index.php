...
<head>
 ...
 <!-- Favicon
 ============================================= -->
 <link rel="shortcut icon" href="assets/images/files/logo.png">
...
.heart-beam {
  ...
  width: 65px;
  height: 50px; }
  .heart-beam::before, .heart-beam::after {
...
#page-title {
  position: relative;
  background: #ccc url("../images/files/parallax-bg/img-1.jpg") no-repeat top center/cover; }
  ...
  #page-title.text-white h5 {
    opacity: 0.7; }
  #page-title.text-white .breadcrumb a, #page-title.text-white .breadcrumb a:hover {
    color: #fff; }
  #page-title h2 {
    margin-bottom: 6px;
    text-transform: uppercase; }
...
#header {
  ...
  #header.text-white .main-menu > li > a:hover {
    color: #fff; }
  #header.text-white .header-btn.colorful {
    background: #fff;
    color: #222;
    border-color: #fff;
    text-shadow: none; }
  #header.text-white .header-btn.hover-transparent-colorful:hover {
    background: transparent;
    color: #fff; }
...
.sticky #header-wrap {
  ...
  .sticky #header-wrap .main-menu > li > a:hover {
    color: #ff4444; }
  .sticky #header-wrap .header-btn.colorful {
    background: #ff4444;
    color: #fff;
    border-color: #ff4444; }
  .sticky #header-wrap .header-btn.hover-transparent-colorful:hover {
    background: transparent;
    color: #ff4444; }
...
.section-title {
  ...
  .section-title.colored h2 {
    color: #ff4444; }
    .section-title.colored h2::after {
      background: #ff4444; }
  .section-title.colored p {
    color: #999; }
...
.box-appointment-form {
  ...
  background-image: url("../images/general-elements/appointment-form-top.png"), url("../images/general-elements/appointment-form-bottom.png");
  background-position: top center, bottom center;
  background-repeat: no-repeat;
  color: #fff;
  border-bottom: 1px solid #eee; }
  .box-appointment-form h2 {
    color: #fff; }
  .box-appointment-form input,
  .box-appointment-form input.form-control,
  .box-appointment-form button,
  .box-appointment-form button.form-control,
  .box-appointment-form textarea,
  .box-appointment-form textarea.form-control,
  .box-appointment-form select,
  .box-appointment-form select.form-control {
    background: transparent;
    color: #fff;
    border: 1px solid rgba(255, 255, 255, 0.3); }
    .box-appointment-form input:focus,
    .box-appointment-form input.form-control:focus,
    .box-appointment-form button:focus,
    .box-appointment-form button.form-control:focus,
    .box-appointment-form textarea:focus,
    .box-appointment-form textarea.form-control:focus,
    .box-appointment-form select:focus,
    .box-appointment-form select.form-control:focus {
      border-color: rgba(255, 255, 255, 0.6); }
  .box-appointment-form ::-webkit-input-placeholder {
    /* Chrome/Opera/Safari */
    color: #fff !important; }
  .box-appointment-form ::-moz-placeholder {
    /* Firefox 19+ */
    color: #fff !important; }
  .box-appointment-form :-ms-input-placeholder {
    /* IE 10+ */
    color: #fff !important; }
  .box-appointment-form :-moz-placeholder {
    /* Firefox 18- */
...
#appointment-form {
  ...
  #appointment-form input[type="submit"] {
    ...
    #appointment-form input[type="submit"]:hover {
      background: transparent;
      color: #fff; }
    #appointment-form input[type="submit"] + img {
      position: relative;
      margin-right: 10px;
      margin: 18px 10px 5px 0; }
      #appointment-form input[type="submit"] + img + h6 {
        position: relative;
        top: 10px;
        display: inline-block;
        color: #fff; }
...
.box-preview-1 {
  ...
  .box-preview-1 .separator-dots {
    margin: 16px 0 20px;
    left: 10px; }
    .box-preview-1 .separator-dots::before, .box-preview-1 .separator-dots::after {
      display: none; }
...
/*  [ 02 ] - Watch Video
========================= */
.watch-video .section-inner {
  background-color: #648cff;
  background-image: url("../images/files/watch-video-top.png"), url("../images/files/watch-video-bottom.png");
  background-position: top center, bottom center;
  background-repeat: no-repeat;
  background-size: contain;
...
.testmonial-single {
  ...
  .testmonial-single .ts-content {
    ...
    height: 215px;
    font-size: 12px;
    padding: 65px 40px 0 37px;
    color: #fff;
    background: url("../images/general-elements/testmonial-single.png") top center no-repeat; }
  .testmonial-single.ts-color-2 .ts-content {
    background-image: url("../images/general-elements/testmonial-single-color-2.png"); }
  .testmonial-single.ts-color-2 .ts-person h4 {
    color: #6487fb; }
  ...
  .testmonial-single .ts-person {
    ...
    text-align: left; }
    .testmonial-single .ts-person h4 {
      position: relative;
      top: -30px;
      left: 12px;
      margin: 0;
...
.our-services {
  ...
  .our-services .section-inner {
    background: #ff4444 url(../images/files/our-services.png) top center/cover no-repeat; }

/* Box Info 1 */
.box-info-1 {
  position: relative; }
  .box-info-1.text-white {
    color: #fff; }
    .box-info-1.text-white p {
      color: rgba(255, 255, 255, 0.85); }
  .box-info-1 .box-icon {
    float: left;
    margin: 0 25px 0 0;
...
.cta-title-1 {
  text-align: center;
  background: #0d0d0d url("../images/general-elements/cta-title1-bg-pattern.png") top center repeat; }
  ...
  .cta-title-1 .cta-btn {
    margin: 40px 0 80px; }
    .cta-title-1 .cta-btn img:first-child {
      margin-right: 20px; }
    .cta-title-1 .cta-btn img:last-of-type {
      margin-left: 20px; }
    .cta-title-1 .cta-btn h6 {
      color: #fff;
      margin-top: 12px; }
...
@media (max-width: 480px) {
  ...
  /* Our Services */ }
element.style {
    background-image: url(/assets/images/files/parallax-bg/img-17.jpg);
...
@keyframes bounce {
 ...
 <!-- Title
 ============================================= -->
 <title>Dial Care | Lab Test's</title>
</head>
...
<body>
 ...
 <div id="website-loading">
  <div class="loader"> <span class="heart-beam"></span> </div>
  <!-- .loader end -->
 </div>
 <!-- .website-loading end -->
 ...
 <div id="full-container">
  ...
  <header id="header" class="style-1" data-scroll-index="0">
   <div id="header-wrap">
    <div class="container">
     <div class="row">
      <div class="col-md-12">
       <a class="logo" href="#"> <img src="assets/images/files/logo.png" data-logo-alt="images/files/logo-alt.png" alt="" style="width:100px; border-radius:50%;">
        <h5><span class="colored">Dial</span></h5> <span>Care Landing</span> </a>
       <!-- .logo end -->
       <ul id="main-menu" class="main-menu">
        <li><a data-scroll-nav="0" href="#header">Home</a></li>
        <!--        <li><a data-scroll-nav="1" href="#make-appointment">Our Packages</a></li>-->
        <!--        <li><a data-scroll-nav="2" href="#happy-clients">Happy Clients</a></li>-->
        <li><a data-scroll-nav="3" href="#our-services">Our Contact</a></li>
        <li><a data-scroll-nav="4" href="#make-appointment">Make Consult</a></li>
       </ul>
       <div class="mobile-menu-btn hamburger hamburger--slider"> <span class="hamburger-box">
  ...
  <!-- Banner
  ============================================= -->
  <section id="banner" class="fullscreen" style="height: 103px !important;">
   <div class="banner-parallax" data-parallax-bg-img="img-17.jpg" data-stellar-background-ratio="0.2" style="background-image: url(assets/images/files/parallax-bg/img-17.jpg); background-position: 50% 0px;" height="200px">
    <!--    <div class="overlay-colored" data-bg-color="#fff" data-bg-color-opacity="0" style="background-color: rgba(255, 255, 255, 0.8);"></div>-->
    <!-- .overlay-colored end -->
  ...
  <a class="fa fa-arrow-down fa-2x scroll-to" href="#make-appointment"></a>
</div>
        <a class="header-btn scroll-to btn small colorful hover-transparent-colorful make" href="#make-appointment">  BOOK NOW </a>
         <!--
         <h1 style="font-weight:lighter;">
          <span style="color:">Lab</span> <span style="font-family:monospace;"></span> Test at Attractive Prices
         </h1>
-->
         <!--         <div class="description"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s. Lorem Ipsum is simply dummy text of the printing industry. </div>--></div>
  ...
  <section id="content">
   <div id="content-wrap">
    <!-- === Make Appointment =========== -->
    <div id="make-appointment" class="flat-section make-appointment" data-scroll-index="1">
     <div class="section-content">
      <div class="container">
       <div class="row">
        <div class="col-md-3 col-sm-6 text-center"> <img src="assets/images/files/doctor-man.png" alt=""> </div>
        <!-- .col-md-3 end -->
        <!--        <div class="col-md-3 col-sm-6 col-md-push-6 text-center hidden-xs"> <img src="assets/images/files/doctor-woman.png" alt=""> </div>-->
        <!-- .col-md-3 end -->
        <div class="col-md-offset-1 col-md-6 col-sm-8 col-md-pull-3">
         <div class="box-appointment-form">
          ...
          <form method="POST" action="index.php" enctype="multipart/form-data">
           ...
           <!-- end Contact Form Submit Message -->
           <div class="form-group">
            <input type="text" name="s_name" id="afName" class="form-control" placeholder="Your Name" required> </div>
           <!-- .form-group end -->
           <div class="form-group">
            <input type="text" name="s_email" id="afEmail" class="form-control" placeholder="Your Email" required> </div>
           <!-- .form-group end -->
           <div class="form-group">
            <input type="integer" class="form-control" placeholder="Phone Number" required name="s_phone"> </div>
           <div class="form-group">
            <select name="select" class="form-control" required>
             <option value="" style="color:black;" selected disabled>Select Test</option>
             <option value="1" style="color:black;">DialCare Basic ( 63 tests )
 </option>
             <option value="2" style="color:black;">DialCare Paleo M ( 77 tests )
</option>
             <option value="3" style="color:black;">Diabetes Package ( 68 TESTS)
</option>
             <option value="4" style="color:black;">Cardio - Diabeto Package ( 94 TESTS)
</option>
<!--
             <option value="5" style="color:black;">CARDIAC RISK MARKERS </option>
             <option value="6" style="color:black;">Thyroid PROFILE(T3-T4-TSH) </option>
             <option value="7" style="color:black;">VITAMIN B-12 </option>
             <option value="8" style="color:black;">HbA1c </option>
-->
            </select>
           </div>
           <div class="form-group">
            <label for="files" style="cursor:pointer; color:white;">Upload Prescription (Optional) </label>
            <input type="file" name="uploaded_file" />
<!--            <input type="file">-->
            <!--             <input type="file" value="Prescription">-->
           </div>
           <!--
           <div class="form-group">
...
-->
           ...
           <!-- .form-group end -->
           <div class="form-group">
            <input type="submit" class="form-control" value="Submit!" style="width:100%;" name="submit"> <img src="assets/images/general-elements/cta-arrow-right.png" alt="" style="margin-top:20px;">
            <h6 style="float:right; margin-top:20px;"><button class="btn btn-success"><a href="tel:9111090909" style="color:white; text-decoration:none;"  class="callingto">Call Us</a></button></h6> </div>
           <!-- .form-group end -->
          </form>
          <!-- #appointment-form end -->
         </div>
         <!-- .box-appointment-form end -->
        </div>
        <!-- .col-md-6 end -->
        <div class="clearfix"></div>
        <section>
...
if(!empty($_FILES['uploaded_file']))
  {
    ...
    if($hamad = move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
...
//      " has been uploaded";
        ...
        //echo "There was an error uploading the file, please try again!";
         ...
         $address = $_POST['address'];
              '<div class="alert alert-success">Record Submitted Successfully</div>';
            // $_POST['submit'] == false;
       ...
       //query run
       //mysqli_query(2param)
  // $sql_query="insert into shan(s_name,f_name,s_email,s_phone)values('$sname','$fname','$mail','$phone')";
  //     $run_query=mysqli_query($conn,$sql_query);
  // }
              $query = "insert into userdata(user_name,user_email,user_phone,user_test_value,prescription,address)values('$sname','$mail','$phone','$select','$path','$address')";
        ...
        <div class="h-100"></div>
        <div class="h2 text-center" style="color:#494E5A;">
         <h2>PACKAGES</h2> </div>
        <div class="row">
         <br>
         <br>
         ...
         <div class="col-md-3 col-sm-6 mb-md-50">
          <div class="box-info-2 text-center">
           <!--           <div class="box-icon"><img src="assets/images/files/box-info-2/img-1.png" alt=""></div>-->
           <div class="box-content mtrl">
            <br>
            <h5 class="newh">DialCare Basic ( 63 tests )
</h5>
            <!--            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum.</p>-->
            <br>
            <div class="feature-item" style="min-height:290px">
             <li class="package-test-wrapper"> CBC </li>
             <li class="package-test-wrapper"> DIABETES SCREEN </li>
             <li class="package-test-wrapper"> TESTOSTERONE </li>
             <li class="package-test-wrapper"> IRON DEFICIENCY PROFILE </li>
             <li class="package-test-wrapper"> LIPID PROFILE </li>
             <li class="package-test-wrapper"> LIVER PROFILE </li>
             <li class="package-test-wrapper"> RENAL PROFILE </li>
             <li class="package-test-wrapper"> THYROID PROFILE </li>
             <li class="package-test-wrapper"> VITAMIN PROFILE </li>
            </div>
            <div class="actual-price"><span class="uncut">Rs-300</span> Rs-900</div> <a class="scroll-to btn small colorful hover-transparent-colorful" href="#make-appointment">  BOOK NOW </a> </div>
           <!-- .box-content end -->
          </div>
          <!-- .box-info-2 end -->
         </div>
         ...
         <div class="col-md-3 col-sm-6 mb-md-50">
          <div class="box-info-2 text-center">
           <!--           <div class="box-icon"><img src="assets/images/files/box-info-2/img-2.png" alt=""></div>-->
           <div class="box-content mtrl">
            <br>
            <h5 class="newh">DialCare Paleo M ( 77 tests )
            ...
            <div class="feature-item" style="min-height:290px">
             <li class="package-test-wrapper"> CBC </li>
             <li class="package-test-wrapper"> DIABETES SCREEN </li>
             <li class="package-test-wrapper"> URINOGRAM </li>
             <li class="package-test-wrapper"> IRON DEFICIENCY </li>
             <li class="package-test-wrapper"> LIPID PROFILE </li>
             <li class="package-test-wrapper"> LIVER PROFILE </li>
             <li class="package-test-wrapper"> RENAL PROFILE </li>
             <li class="package-test-wrapper"> TSH </li>
             <li class="package-test-wrapper"> VITAMIN PROFILE </li>
            </div>
            <div class="actual-price"><span class="uncut">Rs-3500</span> Rs-1199</div> <a class="scroll-to btn small colorful hover-transparent-colorful" href="#make-appointment">  BOOK NOW </a> </div>
           <!-- .box-content end -->
          </div>
          <!-- .box-info-2 end -->
         </div>
         ...
         <div class="col-md-3 col-sm-6 mb-md-50">
          <div class="box-info-2 text-center">
           <!--           <div class="box-icon"><img src="assets/images/files/box-info-2/img-3.png" alt=""></div>-->
           <div class="box-content mtrl">
            <br>
            <h5 class="newh">Diabetes Package ( 68 TESTS)

</h5>
            <!--            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum.</p>-->
            <br>
            <div class="feature-item" style="min-height:290px">
             <li class="package-test-wrapper"> CARDIAC RISK MARKER SMALL </li>
             <li class="package-test-wrapper"> ELECTROLYTES </li>
             <li class="package-test-wrapper"> PANCREATIC ENZYMES </li>
             <li class="package-test-wrapper"> CBC </li>
             <li class="package-test-wrapper"> DIABETES SCREEN SMALL </li>
             <li class="package-test-wrapper">HORMONE </li>
             <li class="package-test-wrapper"> IRON DEFICIENCY PROFILE </li>
             <li class="package-test-wrapper"> LIVER PROFILE </li>
             <li class="package-test-wrapper"> RENAL PROFILE </li>
             <li class="package-test-wrapper"> THYROID PROFILE </li>
            ...
            <div class="actual-price"><span class="uncut">Rs-4000</span> Rs-1450</div> <a class="scroll-to btn small colorful hover-transparent-colorful" href="#make-appointment">  BOOK NOW </a> </div>
           <!-- .box-content end -->
          </div>
          <!-- .box-info-2 end -->
         </div>
  ...
  <!-- === Our Services =========== -->
  <!-- === Contact Details =========== -->
  <div class="parallax-section contact-details" data-scroll-index="3">
   <div class="section-inner">
    <div class="container">
     <div class="row">
      <div class="section-content">
       <div class="col-md-4">
        <div class="box-info-1 text-white text-center mb-md-50">
         <div class="box-content">
          <h4>General Info</h4>
          <p>Visit our Website
           <br> <a href="https://www.dialcare.in/" style="color:white;">https://www.dialcare.in/</a></p>
         </div>
         <!-- .box-content end -->
        </div>
        <!-- .box-info-1 end -->
       ...
       <div class="col-md-4">
        <div class="box-info-1 text-white text-center mb-md-50">
         <div class="box-content">
          <h4>Contact</h4>
<!--          <p><a href="tel:+91-9111090909" style="color:white;"><button class="btn btn-default"> Call US</button> </a>-->
          <p>
           <br> contact@dialcare.in</p>
         </div>
         <!-- .box-content end -->
        </div>
        <!-- .box-info-1 end -->
       ...
       <!-- .col-md-4 end -->
       <div class="col-md-4">
        <div class="box-info-1 text-white text-center">
         <div class="box-content">
          <h4>Address</h4>
          <p>DialCare, 413, RIIDL, SIMSR, Somaiya VidyaVihar, Mumbai
           <br>
          </p>
         </div>
         <!-- .box-content end -->
  ...
  <footer id="footer-mini">
   <div class="container">
    <div class="row">
     <div class="col-md-12">
      <div class="copyrights-message text-center" style="margin-left:40%;">2018 © <span class="colored" style="color:green;">Dial Care.</span> All Rights Reserved</div>
 ...
 <!-- #full-container end -->
 <a class="scroll-top" href="#"><img src="assets/images/general-elements/scroll-top.png" alt=""></a>
